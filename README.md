...
| 모듈 (Module) | 핀 역할 (Function) | STM32F103C8T6 연결 핀 | 비고 |
| :--- | :--- | :--- | :--- |
| **DS18B20** (온도 센서) | DATA | **PA3** | OneWire 데이터 통신 라인 |
| **FND (74HC595D)** | RCLK (Latch) | **PB13** | 디스플레이 출력 래치 클럭 |
| **FND (74HC595D)** | DIO (Data) | **PB14** | 디스플레이 직렬 데이터 입력 |
| **FND (74HC595D)** | SCLK (Shift) | **PB15** | 디스플레이 시프트 클럭 |
| **Relay Module** | IN (제어 신호) | **PB5** | 히터 전원 ON/OFF 제어용 |
| **Tact Switch** | 일반 스위치 | **PA0** | - |
| **Tact Switch** | 온도 설정(UP) | **PB0** | 목표 온도 조절용 (추후 기능 활성화 예정) |
---
